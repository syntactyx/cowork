...
// Remove the broken handler if it was partially inserted
main = main.replace(/\nipcMain\.handle\("compact-conversation"[\s\S]*?\}\);\n/m, '\n');
...
console.log(main.includes('compact-conversation') ? 'Done!' : 'FAILED');
